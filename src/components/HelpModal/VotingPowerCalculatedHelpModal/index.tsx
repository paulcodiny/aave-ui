...
export default function VotingPowerCalculatedHelpModal({
  text,
  iconSize,
  className,
  color,
  ...
  return (
    <>
      <HelpModalWrapper
        text={text}
        iconSize={iconSize}
        className={classNames('VotingPowerCalculatedHelpModal', className)}
        caption={intl.formatMessage(messages.caption)}
        description={
          <div className="VotingPowerCalculatedHelpModal__content">
